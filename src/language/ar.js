export const arabic = {
  ...
  "Welcome to GalaEazy!": "ي 6 صباحًا مارت",
  ...
  "Register as seller and open shop in GalaEazy to start your business":
    "سجل كبائع ومتجر مفتوح في GalaEazy لبدء عملك",
  ...
  eBusiness: "Ebusiness",
  Solution: "حل",
  "GalaEazy is a Laravel and Flutter Framework-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business functionality.":
    "GalaEazy عبارة عن نظام توصيل متعدد البائعين ، والبقالة ، والتجارة الإلكترونية ، والتجارة الإلكترونية ، والتجارة الإلكترونية ، والطرز ، ونظام توصيل الصيدلة ، GalaEazy عبارة عن نظام توصيل الصيدلة ، وتجارة الإلكترون ، والتجارة الإلكترونية ، والطرد ، ونظام توصيل الصيدلة. لديها ست وحدات لتغطية جميع وظائف عملك.",
  ...
  "They create a account on GalaEazy using your code and place their first order":
    "يقومون بإنشاء حساب على GalaEazy باستخدام الكود الخاص بك ويضعون طلبهم الأول",
