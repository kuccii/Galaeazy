export const bengali = {
  ...
  "Register as seller and open shop in GalaEazy to start your business":
    "سجل كبائع وافتح متجرًا في GalaEazy لبدء عملك",
  ...
  "GalaEazy is a Laravel and Flutter Framework-based multi-vendor food, grocery, eCommerce, parcel, and pharmacy delivery system. It has six modules to cover all your business functionality.":
    "GalaEazy عبارة عن نظام متعدد البائعين للأغذية والبقالة والتجارة الإلكترونية والطرود والصيدليات قائم على Laravel و Flutter Framework. يحتوي على ست وحدات لتغطية جميع وظائف عملك.",
