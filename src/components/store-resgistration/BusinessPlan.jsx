          ...
          {configData?.commission_business_model !== 0 && (
            ...
            >
              ...
              <Typography fontSize="13px" color={theme.palette.neutral[400]}>
                {t(
                  `Store will pay ${configData?.admin_commission}% commission to GalaEazy from each order. You will get access of all the features and options  in store panel , app and interaction with user.`
                )}
              </Typography>
            </Stack>
          )}
